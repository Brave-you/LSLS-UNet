...
from models.lslsunet import LSLSNet
from engine import *
import os
import sys
...
def main(config):
    ...
    if config.network == 'egeunet':
        model = LSLSNet(num_classes=model_cfg['num_classes'],
    ...
    if os.path.exists(os.path.join(checkpoint_dir, 'best.pth')):
        ...
        os.rename(
            ...
            os.path.join(checkpoint_dir, f'best-epoch{min_epoch}-loss{min_value:.4f}.pth')
        )      
